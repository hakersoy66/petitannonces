const cards = [
  ...
  ["Litiges", "—", "Transactions contestées"],
];

const nav = [
  ["Utilisateurs", "/users"], ["Annonces", "/listings"], ["Finance", "/finance"],
  ["Support", "/support"], ["Modération", "/moderation"], ["Conformité", "/compliance"], ["Analytics", "/analytics"],
];
...
export default function AdminHome() {
  return <main style={{ minHeight: "100vh", background: "#f6f7fb", color: "#17172b" }}>
    ...
    <section style={{ maxWidth: 1280, margin: "0 auto", padding: 36 }}>
      ...
      <p style={{ color: "#717183", marginBottom: 28 }}>Pilotage utilisateurs, marketplace, finance, support, confiance et conformité.</p>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: 18, marginTop: 22 }}>
        <article style={{ background: "white", border: "1px solid #e8e8ef", borderRadius: 18, padding: 22 }}><h2>Activité marketplace</h2><p style={{ color: "#77778a" }}>Les KPI réels sont fournis par <code>/admin/dashboard</code> et l’historique par <code>/admin/analytics/daily</code>.</p></article>
        <article style={{ background: "#17172b", color: "white", borderRadius: 18, padding: 22 }}><h2>Priorités</h2><p>Tickets urgents, litiges actifs, cas de modération critiques et demandes conformité apparaîtront ici.</p></article>
      </div>
    </section>
  </main>;
}

  ...
  return (
    <div id="top" className="page-shell">
      ...
      <main>
          ...
          <div className="shell hero-layout">
            ...
            <div className="hero-showcase" aria-label="Aperçu de la plateforme">
              ...
              <article className="showcase-card showcase-main-card">
                <div className="showcase-photo phone-art">
                  <span className="phone-camera camera-one" />
                  <span className="phone-camera camera-two" />
                  <span className="phone-camera camera-three" />
                  <span className="phone-logo">●</span>
                </div>
                <div className="showcase-card-body">
                  <div>
                    <span className="listing-badge">Achat sécurisé</span>
                    <h2>iPhone 16 Pro · 256 Go</h2>
                    <p>Lyon 2e · Comme neuf</p>
                  </div>
                  <strong>829 €</strong>
                </div>
              </article>
              <div className="floating-card floating-offer">
                <span className="floating-icon">€</span>
                <div><small>Nouvelle offre</small><strong>780 €</strong></div>
                <span className="success-pill">+12%</span>
              </div>
              <div className="floating-card floating-trust">
                <span className="floating-icon verified">✓</span>
                <div><small>Profil</small><strong>Vérifié</strong></div>
              </div>
            </div>
          </div>
        </section>

        <section id="categories" className="section-block categories-section">
          <div className="shell">
        ...
        <section id="annonces" className="section-block listings-section">
          <div className="shell">
            <div className="section-heading heading-row">
              ...
              {listings.map((listing, index) => (
                <article className="listing-card" key={listing.title}>
                  <div className={`listing-visual listing-visual-${listing.tone}`}>
                    <span className="visual-watermark">{index === 0 ? "16" : index === 1 ? "3008" : index === 2 ? "PA" : "M4"}</span>
                    <button className="favorite-button" type="button" aria-label={`Ajouter ${listing.title} aux favoris`}>♡</button>
                    {index === 1 && <span className="pro-badge">PRO</span>}
                  </div>
                  <div className="listing-content">
                    ...
                    <div className="listing-price-row"><strong>{listing.price}</strong>{index === 0 && <span className="protected-label">✓ Protégé</span>}</div>
                  </div>
                </article>
              ))}
            </div>
        ...
        <section id="boutiques" className="section-block pro-section">
          <div className="shell pro-panel">
            ...
            <div className="pro-mockup" aria-label="Aperçu d'une boutique professionnelle">
              ...
              <div className="store-cover"><div className="store-avatar">AL</div><div><strong>Atelier Lyon</strong><small>Mobilier & décoration · Professionnel vérifié</small></div></div>
              <div className="store-stats"><div><strong>142</strong><small>Annonces</small></div><div><strong>4,9/5</strong><small>Évaluation</small></div><div><strong>&lt; 1 h</strong><small>Réponse</small></div></div>
              <div className="store-products"><span /><span /><span /></div>
            </div>
          </div>
        </section>

...
export default async function ListingPage({params}:Props){
 ...
 const compareSelection={id:listing.id,slug:listing.slug,title:listing.title,imageUrl:listing.media?.[0]?.url??null,priceMinor:listing.priceMinor,currency:listing.currency,city:listing.city,category:{name:listing.category.name,slug:listing.category.slug,domain:listing.category.domain}};

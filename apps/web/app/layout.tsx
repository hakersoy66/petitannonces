...
type SiteConfig={
 ...
 ogImageUrl:string|null;accentColor:string;seoTitle:string;seoDescription:string;navigationCategorySlugs?:string[];
};
type HeaderCategory={id:string;name:string;slug:string;domain:string;children?:HeaderCategory[]};

const fallbackSite:SiteConfig={siteName:"Petit Annonces",tagline:"Achetez et vendez partout en France",logoUrl:null,footerLogoUrl:null,appLogoUrl:null,mobileLogoUrl:null,pwaIconUrl:null,pwaIcon180Url:null,pwaIcon192Url:null,pwaIcon512Url:null,faviconUrl:null,ogImageUrl:null,accentColor:"#5b4cf0",seoTitle:"Petit Annonces FR – Petites annonces gratuites en France",seoDescription:"Achetez et vendez partout en France sur Petit Annonces. Publiez gratuitement vos annonces de véhicules, immobilier, high-tech, maison, emploi et services."};
...
export async function generateViewport():Promise<Viewport>{const site=await siteConfig();return{themeColor:site.accentColor,width:"device-width",initialScale:1,viewportFit:"cover",interactiveWidget:"resizes-content"}}

...
const fallback:FooterConfig={
 ...
 footerGroups:[
  {title:"Petit Annonces",links:[{label:"Qui sommes-nous ?",href:"/qui-sommes-nous"},{label:"Presse & médias",href:"/presse"},{label:"Sécurité",href:"/conformite"},{label:"Confidentialité",href:"/confidentialite"},{label:"Cookies",href:"/cookies"},{label:"Mentions légales",href:"/mentions-legales"},{label:"Classement & référencement",href:"/classement-referencement"},{label:"Rétractation en ligne",href:"/retractation"}]},
...
export function SiteFooter({initialConfig}:{initialConfig?:Partial<FooterConfig>}){
 ...
 if(legal&&!legal.links.some(l=>l.href==="/mentions-legales"))legal.links.push({label:"Mentions légales",href:"/mentions-legales"});if(legal&&!legal.links.some(l=>l.href==="/classement-referencement"))legal.links.push({label:"Classement & référencement",href:"/classement-referencement"});if(legal&&!legal.links.some(l=>l.href==="/retractation"))legal.links.push({label:"Rétractation en ligne",href:"/retractation"});
 if(info&&!info.links.some(l=>l.href==="/assistance"))info.links.push({label:"Centre d’aide",href:"/assistance"});
 return <footer className="site-footer"><div className="footer-mobile-simple"><div className="footer-mobile-head"><a className="footer-mobile-brand" href="/">Petit Annonces</a><p>{config.footerDescription}</p></div><div className="footer-mobile-cta"><a className="footer-google-play" href="https://play.google.com/store/apps/details?id=fr.petitannonces.petitannoncesapp&hl=fr&gl=FR" target="_blank" rel="noopener noreferrer" aria-label="Télécharger Petit Annonces sur Google Play"><span className="footer-google-play-icon" aria-hidden="true">▶</span><span><small>Disponible sur</small><strong>Google Play</strong></span></a><span className="footer-app-store is-disabled" aria-label="App Store bientôt disponible"><span className="footer-app-store-icon" aria-hidden="true"></span><span><small>Bientôt disponible</small><strong>App Store</strong></span></span></div><div className="footer-mobile-legal"><a href="/qui-sommes-nous">À propos</a><a href="/conditions-generales">Conditions</a><a href="/confidentialite">Confidentialité</a><a href="/mentions-legales">Mentions légales</a><a href="/classement-referencement">Classement</a><a href="/retractation">Rétractation</a></div><div className="footer-mobile-bottom"><span>Infrastructure & développement · <a href="https://getsy.fr" target="_blank" rel="noopener noreferrer">Getsy</a></span></div></div><div className="footer-desktop-rich">
   ...
   <div className="shell footer-grid">
    <div className="footer-brand">
      ...
      <div className="footer-store-buttons"><a className="footer-google-play" href="https://play.google.com/store/apps/details?id=fr.petitannonces.petitannoncesapp&hl=fr&gl=FR" target="_blank" rel="noopener noreferrer" aria-label="Télécharger Petit Annonces sur Google Play"><span className="footer-google-play-icon" aria-hidden="true">▶</span><span><small>Disponible sur</small><strong>Google Play</strong></span></a><span className="footer-app-store is-disabled" aria-label="App Store bientôt disponible"><span className="footer-app-store-icon" aria-hidden="true"></span><span><small>Bientôt disponible</small><strong>App Store</strong></span></span></div>
    </div>
   ...
   <div className="shell footer-bottom"><span></span><div><a href="/conditions-generales">Conditions générales</a><a href="/confidentialite">Confidentialité</a><span>Marketplace pensée pour la France 🇫🇷</span><span>Infrastructure & développement : <a href="https://getsy.fr" target="_blank" rel="noopener noreferrer">Getsy</a></span></div></div>
  </div></footer>
}
